    ...
    return (
        <main id='profile' className=' container-fluid vh-100 '> 
            <section className='opaque-background rounded-2 container px-3 py-4 d-flex flex-column gap-4'> 
                <h6 className='m-0 fw-bold text-warning d-flex justify-content-between'><span>Profile</span> <button className='btn btn-outline-success' type='button' onClick={() => (navigate('/auth/user-login'))}><IconPark path={'ic:baseline-logout'} size={20} />Logout</button></h6>
